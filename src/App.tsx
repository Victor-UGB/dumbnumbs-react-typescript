...
const App:React.FC = () => {
  ...
  return (
    <div className="App bg-gradient-to-br from-zinc-900 to-black" >
      <div className='h-full items-center flex flex-col p-2 pb-8' style={{maxHeight: "100dvh", height: "100dvh", borderRadius: ''}}>
        <div className='flex flex-col justify-between h-2/5 items-center w-full px-5 text-xl font-extrabold text-zinc-800 inner shadow-black rounded m-4'>
          ...
          <div className=' my-1 font-black w-full self-center overflow-x-scroll overflow-y-hidden text-end'>
              <div className='mt-3 overflow-x-scroll text-3xl overflow-y-hidden text-end text-zinc-400 w-full font-light'>{firstNumEntered}</div>
              <div className='text-6xl py-3'> 
        ...
        <div className='flex w-full relative h-3/5 p-2'>
          ...
          <div className='basis-1/4 justify-between h-full flex flex-col m-2 pb-2'>
            {
              operators.map(op => 
      ...
      <div className='text-center font-bold text-sm text-zinc-500 py-3 bg-gradient-to-br from-zinc-900 to-black w-full'>
        <a href='https://twitter.com/withLove_Victor'>@withLove_Victor</a>
      </div>
    </div>
  );
}
